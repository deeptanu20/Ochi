...
const Footer = () => {
  return (
    <div data-scroll data-scroll-speed="-.3" className=' flex gap=5 w-full h-screen bg-zinc-400 p-20 font-["Founders_Grotesk_X_condensed"]'>
      <div  className='w-1/2 h-full flex flex-col justify-between '>
        <div className='heading'>
        <h1 className='text-[9vw] text-neutral-800 font-light leading-none -mb-10'>EYE-</h1>
        <h1 className='text-[9vw]  text-neutral-800 font-light leading-none -mb-10'>OPENING</h1>
        </div>
      ...
      <div className='w-1/2'>
      <h1 className='text-[8vw]  text-neutral-800 font-light leading-none -mb-10'>PRESENTATION
      
      
      </h1>

      <div className='dets font-["Neue_Montreal mt-10 gap-10 "] '>
           <a  className="block text-4xl text-neutral-800 font-light  "href="#">Instagram</a>
           <a className="block text-4xl  text-neutral-800 font-light  " href="#">Facebook</a>
           <a className="block text-4xl text-neutral-800 font-light"href="#">Twitter</a>
           <a className="block text-4xl text-neutral-800  font-light " href="#">Linkdin</a>
           
           <a className="block text-4xl  text-neutral-800  font-light"href="#">Youtube</a>
      </div>
      </div>
    </div>
  )
